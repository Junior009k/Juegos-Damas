...
let cuadroSeleccionado, cuadroObjetivo, banderaS=1,jugador=1,movimiento=0,posibilidadesDeLaReina=[],diagonalesDeLaReina=[],posibilidadesDeAtaqueDeLaReina=[];
diagonalesDeLaReina=["99","99","99","99"]
        ...
        while(j<8)
        {
            document.getElementById("cuadro" + i + j).addEventListener("click",(e)=>
            {
                ...
                if(banderaS==1)
                {
                    ...
                    if(document.getSelection().anchorOffset==1)
                    {
                        ...
                        if(jugador==1 && movimiento==0)
                        {
                            ...
                            if(cuadroSeleccionado.getAttribute("fichadelJugador")=="1" && cuadroSeleccionado.getAttribute("reina")=="true")
                            {
                                ...
                                banderaS=2;
                                posibilidadesDeAtaqueDeLaReina=[];
                                ...
                                while(x>posicionArriba && y>posicionIzquierda)
                                {
                                    ...
                                    // si no se cumple una podria explotar
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        ...
                                        if( ((x-1)!=9 && (y-1)!=-1 && (x-1)!=-1 &&( y-1)!=8) && document.getElementById("cuadro" + (x-1) + "" + (y-1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            let j=2;
                                            diagonalesDeLaReina[0]=((x-1) + "" + (y-1))
                                            posibilidadesDeAtaqueDeLaReina.push((x-1) + "" + (y-1))
                                            document.getElementById("cuadro" + diagonalesDeLaReina[0]).style.setProperty("Background-color","#F00")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                //ahora si,estaba confundido
                                                //el ciclo se rompera si se sale de los limites
                                                //si x es mayor que 8 o es menor a 0 se rompe 
                                                //si y es mayor que 10 o es menor a 0 se rompe
                                                if(((x-j)<0 || (y-j)<0 || (x-j)>9||( y-j)>7))break;
                                                if(document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="0")
                                                {
                                                    posibilidadesDeAtaqueDeLaReina.push((x-j) + "" + (y-j));
                                                    document.getElementById("cuadro" + (x-j) + "" + (y-j)).style.setProperty("Background-color","#F00")
                                                    console.log((x-j) + "" + (y-j))
                                                }
                                                if(document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="1" || document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="2")break;
                                                ++j;
                                            } 
                                        }
                                        break;
                                ...
                                while(x>posicionArriba && y<posicionDerecha)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        ...
                                        {
                                            let j=2;
                                            diagonalesDeLaReina[1]=((x-1) + "" + (y+1))
                                            posibilidadesDeAtaqueDeLaReina.push((x-1) + "" + (y+1))
                                            document.getElementById("cuadro" + diagonalesDeLaReina[1]).style.setProperty("Background-color","#F00")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x-j)<0 || (y+j)<0 || (x-j)>9||( y+j)>7))break;
                                ...
                                while(x<posicionAbajo && y>posicionIzquierda)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        ...
                                        {
                                            let j=2;
                                            diagonalesDeLaReina[2]=((x+1) + "" + (y-1))
                                            posibilidadesDeAtaqueDeLaReina.push((x+1) + "" + (y-1))
                                            document.getElementById("cuadro" + diagonalesDeLaReina[2]).style.setProperty("Background-color","#F00")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x+j)<0 || (y-j)<0 || (x+j)>9||( y-j)>7))break;
                                ...
                                while(x<posicionAbajo && y<posicionDerecha)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        ...
                                        {
                                            let j=2;
                                            diagonalesDeLaReina[3]=((x+1) + "" + (y+1))
                                            posibilidadesDeAtaqueDeLaReina.push((x+1) + "" + (y+1))
                                            document.getElementById("cuadro" + diagonalesDeLaReina[3]).style.setProperty("Background-color","#F00")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x+j)<0 || (y+j)<0 || (x+j)>9||( y+j)>7))break;
                        ...
                        if(jugador==2 && movimiento==0)
                        {
                            ...
                            if(cuadroSeleccionado.getAttribute("fichadelJugador")=="2" && cuadroSeleccionado.getAttribute("reina")=="true")
                            {
                                ...
                                {
                                    //si encuentra una ficha del jugador hay se acaban la posibilidades de movimiento
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="1" )
                                    {
                                        //en vez de solo rompe el bucle agregaremos la posibilidades de ataque
                                        //pero antes vamos hacer una prueba
                                        //vamos a validar aqui si la ficha despues de la ficha del riva esta en blaco, ponlo de color rojo
                    ...
                    if(movimiento==2 && cuadroSeleccionado.getAttribute("reina")=="false")
                    {
                        
                        banderaS=2;
                    }
                    //ESTO VALIDARA QUE EL JUGADOR COMA POR TERCERA VEZ QUE FAIL XD
                    if(movimiento==3 && cuadroSeleccionado.getAttribute("reina")=="false")
                    {
                        
                        banderaS=2;
                    }
                    //ESTO VALIDARA QUE EL JUGADOR COMA POR TERCERA VEZ QUE FAIL XD
                    if(movimiento==4 && cuadroSeleccionado.getAttribute("reina")=="false")
                    {
                        
                        banderaS=2;
                    }
                    //ESTO VALIDARA QUE EL JUGADOR COMA POR TERCERA VEZ QUE FAIL XD
                    if(movimiento==5 && cuadroSeleccionado.getAttribute("reina")=="false")
                    {
                        
                        banderaS=2;
                    }
                    //2do Ataque para la dama, tiene que entrar en esta condicional 
                    if(movimiento==2 && document.getElementById(cuadroObjetivo).getAttribute("reina")=="true")
                    {
                        //esto lo mandara para seleccionar
                        console.log("movimiento 2 de la Reina entro a la bandera 1 Cuadro Objetivo console.log" + cuadroObjetivo)
                        
                        
                        banderaS=2;
                        //tengo que actualizar el

                    }
                    //ESTO VALIDARA QUE EL JUGADOR COMA POR TERCERA VEZ QUE FAIL XD
                    if(movimiento==3 && cuadroSeleccionado.getAttribute("reina")=="true")
                    {
                        
                        banderaS=2;
                    }
                    //ESTO VALIDARA QUE EL JUGADOR COMA POR TERCERA VEZ QUE FAIL XD
                    if(movimiento==4 && cuadroSeleccionado.getAttribute("reina")=="true")
                    {
                        
                        banderaS=2;
                    }
                    //ESTO VALIDARA QUE EL JUGADOR COMA POR TERCERA VEZ QUE FAIL XD
                    if(movimiento==5 && cuadroSeleccionado.getAttribute("reina")=="true")
                    {
                ...
                if(banderaS==2 && h==banderaS)
                {
                    if(jugador==1)
                    {
                        ...
                        if(document.getSelection().anchorOffset==0 && document.getSelection().anchorNode.getAttribute("value")=="1")
                        {
                            ...
                            //no funciono
                            // aqui le digo que tambien tenga la posibilidad que el objetivo pueda estar atras
                            if (((parseInt(document.getSelection().anchorNode.getAttribute("x"))+2)==cuadroSeleccionado.getAttribute("x")||(parseInt(document.getSelection().anchorNode.getAttribute("x"))-2)==cuadroSeleccionado.getAttribute("x")) &&( movimiento==0 && cuadroSeleccionado.getAttribute("reina")=="false" && document.getElementById(cuadroObjetivo).getAttribute("reina")=="false"))
                            {
                               ...
                               //Esta validacion solo tenia la posibilidad de la parte de alante
                               //ahora con esta actualizacion tienen en cuenta la cuatros referencia
                               //=============================================================================================================
                               //cuando la posicion objetivo sea superior a la posicion final
                               if (parseInt(miPosicion[0])==(parseInt(posicionObjetivo[0])+2)) 
                                {
                                    x=parseInt(posicionObjetivo[0] ) +1;
                                    if(parseInt(miPosicion[1])==(parseInt(posicionObjetivo[1])+2))
                                    {
                        ...
                        if(movimiento==2 && cuadroSeleccionado.getAttribute("reina")=="false" && document.getElementById(cuadroObjetivo).getAttribute("reina")=="false")
                        {
                        ...
                        if(movimiento==3 && posicionInicial!=(document.getSelection().anchorNode.getAttribute("x") + "" + document.getSelection().anchorNode.getAttribute("y")) && cuadroSeleccionado.getAttribute("reina")=="false" && document.getElementById(cuadroObjetivo).getAttribute("reina")=="false")
                        {
                        ...
                        if(movimiento==4 && posicionInicial!=(document.getSelection().anchorNode.getAttribute("x") + "" + document.getSelection().anchorNode.getAttribute("y")) && cuadroSeleccionado.getAttribute("reina")=="false" && document.getElementById(cuadroObjetivo).getAttribute("reina")=="false")
                        {
                        ...
                        if(movimiento==5 && posicionInicial!=(document.getSelection().anchorNode.getAttribute("x") + "" + document.getSelection().anchorNode.getAttribute("y")) && cuadroSeleccionado.getAttribute("reina")=="false" && document.getElementById(cuadroObjetivo).getAttribute("reina")=="false")
                        {
                            //hay que resolver porque se queda frizado
                        ...
                        //movimiento y ataque de la reina
                        if(cuadroSeleccionado.getAttribute("reina")=="true" && movimiento!=2 && movimiento==0)
                        {   
                            let i=0;
                            ...
                            while(i<posibilidadesDeAtaqueDeLaReina.length)
                            {
                                //si la posicion objetivo esta dentro de la posibilidades, podra moverse sino no se movera
                                if((x+""+y)==posibilidadesDeAtaqueDeLaReina[i])
                                {
                                    puedoAtacar=true;
                                    //vamos hacer un algoritmo que nos permita saber a cual diagonal escogio 
                                    //hay 4 posible escenario
                                    //si ataco hacia Diagonal superior izquierda -x -y
                                    if     (cuadroSeleccionado.getAttribute("x")>x && cuadroSeleccionado.getAttribute("y")>y)auxiliarAtaque=((parseInt(diagonalesDeLaReina[0][0])+1))+ "" + (parseInt(diagonalesDeLaReina[0][1])+1);
                                    //si ataco hacia Diagonal superior Derecha -x +y
                                    else if(cuadroSeleccionado.getAttribute("x")>x && cuadroSeleccionado.getAttribute("y")<y)auxiliarAtaque=((parseInt(diagonalesDeLaReina[1][0])+1))+ "" + (parseInt(diagonalesDeLaReina[1][1])-1);
                                    //si ataco hacia Diagonal inferior izquierda +x -y
                                    else if(cuadroSeleccionado.getAttribute("x")<x && cuadroSeleccionado.getAttribute("y")>y)auxiliarAtaque=((parseInt(diagonalesDeLaReina[2][0])-1))+ "" + (parseInt(diagonalesDeLaReina[2][1])+1);
                                    //si ataco hacia Diagonal inferior Derecha +x +y
                                    else if(cuadroSeleccionado.getAttribute("x")<x && cuadroSeleccionado.getAttribute("y")<y)auxiliarAtaque=((parseInt(diagonalesDeLaReina[3][0])-1))+ "" + (parseInt(diagonalesDeLaReina[3][1])-1);
                                    console.log("ficha del jugador" + auxiliarAtaque)
                                    console.log("puedoAtacar" + puedoAtacar)
                                }
                                document.getElementById("cuadro"+ posibilidadesDeAtaqueDeLaReina[i]).style.setProperty("Background-color","#FFF")
                                console.log("posibilidad donde la reina puede Atacar" +posibilidadesDeAtaqueDeLaReina[i])
                                
                                ++i;
                            }
                            if(diagonalesDeLaReina[0]!="99")document.getElementById("cuadro"+ diagonalesDeLaReina[0]).style.setProperty("Background-color","#FFF")
                            if(diagonalesDeLaReina[1]!="99")document.getElementById("cuadro"+ diagonalesDeLaReina[1]).style.setProperty("Background-color","#FFF")
                            if(diagonalesDeLaReina[2]!="99")document.getElementById("cuadro"+ diagonalesDeLaReina[2]).style.setProperty("Background-color","#FFF")
                            if(diagonalesDeLaReina[3]!="99")document.getElementById("cuadro"+ diagonalesDeLaReina[3]).style.setProperty("Background-color","#FFF")
                            if(puedoMover)
                            {
                                //elimina la ficha del cuadro seleccionado y lo introduce en el cuadro sobjetivo
                                document.getElementById(cuadroSeleccionado.getAttribute("id")).innerHTML="";
                            ...
                            if(puedoAtacar)
                            {
                                ...
                                //valida si puede hacer un ataque doble con la reina
                                //vamos a validar si puede hacer un segundo ataque 
                                //solo estamos validando si va a atacar y no el movimiento
                                //===========================================================
                                console.log("VALIDACION SEGUNDO ATAQUE REINA")
                                document.getElementById(cuadroObjetivo).style.setProperty("Background-color","#fA1")
                                //banderaS=1;
                                posibilidadesDeAtaqueDeLaReina=[];
                                posibilidadesDeLaReina=[];
                                diagonalesDeLaReina=["99","99","99","99"];
                                ...
                                let posicionDerecha=8;
                                let posicionIzquierda=-1;
                                x=document.getElementById(cuadroObjetivo).getAttribute("x");
                                y=document.getElementById(cuadroObjetivo).getAttribute("y");
                            
                                //1 MOVIMIENTO HACIA DIAGONAL IZQUIERDA
                                console.log("posicion que puede ir la reina hacia la diagonal Superior izquierda")
                                console.log(x+ "" + y);
                                while(x>posicionArriba && y>posicionIzquierda)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        ...
                                        if( ((x-1)!=9 && (y-1)!=-1 && (x-1)!=-1 &&( y-1)!=8) && document.getElementById("cuadro" + (x-1) + "" + (y-1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x-1) + "" + (y-1))
                                            movimiento=2;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[0]).style.setProperty("Background-color","#0F0")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                //ahora si,estaba confundido
                                                ...
                                                {
                                                    posibilidadesDeAtaqueDeLaReina.push((x-j) + "" + (y-j));
                                                    document.getElementById("cuadro" + (x-j) + "" + (y-j)).style.setProperty("Background-color","#0F0")
                                                    console.log((x-j) + "" + (y-j))
                                                }
                                                if(document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="1" || document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="2")break;
                                                ++j;
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="1" && x!=document.getElementById(cuadroObjetivo).getAttribute("x") && y!=document.getElementById(cuadroObjetivo).getAttribute("y"))break;
                                    //si el bucle no termina, este agrega una posibilidad de movimiento 
                                    --x;
                                    --y;
                                    if(x==9 || y==-1 || x==-1 || y==8)break;
                                ...
                                x=document.getElementById(cuadroObjetivo).getAttribute("x");
                                y=document.getElementById(cuadroObjetivo).getAttribute("y");
                                //2 MOVIMIENTO HACIA superior DIAGONAL DERECHA
                                console.log("posicion que puede ir la reina hacia la diagonal SUPERIOR derecha")
                                console.log(x+ "" + y);
                                while(x>posicionArriba && y<posicionDerecha)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x-1)!=9 &&  (y+1)!=-1 &&  (x-1)!=-1 && ( y+1)!=8) && document.getElementById("cuadro" + (x-1) + "" + (y+1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x-1) + "" + (y+1))
                                            movimiento=2;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[1]).style.setProperty("Background-color","#0F0")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x-j)<0 || (y+j)<0 || (x-j)>9||( y+j)>7))break;
                                ...
                                x=document.getElementById(cuadroObjetivo).getAttribute("x");
                                y=document.getElementById(cuadroObjetivo).getAttribute("y");
                                //3 MOVIMIENTO HACIA DIAGONAL IZQUIERDA INFERIOR
                                console.log("posicion que puede ir la reina hacia la diagonal inferior izquierda")
                                console.log(x+ "" + y);
                                while(x<posicionAbajo && y>posicionIzquierda)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x+1)!=9 && (y-1)!=-1 && (x+1)!=-1 &&( y-1)!=8) && document.getElementById("cuadro" + (x+1) + "" + (y-1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x+1) + "" + (y-1))
                                            movimiento=2;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[2]).style.setProperty("Background-color","#0F0")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x+j)<0 || (y-j)<0 || (x+j)>9||( y-j)>7))break;
                                ...
                                x=document.getElementById(cuadroObjetivo).getAttribute("x");
                                y=document.getElementById(cuadroObjetivo).getAttribute("y");
                                //4 MOVIMIENTO HACIA DIAGONAL DERECHA INFERIOR
                                console.log("posicion que puede ir la reina hacia la diagonal inferior derecha")
                                console.log(x+ "" + y);
                                while(x<posicionAbajo && y<posicionDerecha)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x-1)!=9 &&  (y+1)!=-1 &&  (x-1)!=-1 && ( y+1)!=8) && document.getElementById("cuadro" + (x+1) + "" + (y+1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x+1) + "" + (y+1))
                                            movimiento=2;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[3]).style.setProperty("Background-color","#0F0")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x+j)<0 || (y+j)<0 || (x+j)>9||( y+j)>7))break;
                            ...
                            //vamos a darle valor al cuadroseleccionado
                            //vamos a igualar esto dos valores para usarlo como condicional para que no entre al
                            //movimiento 2 bandera 2, sino que entre al movimiento 2 de la reina de bandera 1
                            // 
                            else{cuadroSeleccionado=document.getElementById(cuadroObjetivo)};
                                //===========================================================
                                //sera diferente a las fichas aqui se mandara directamente a movimiento 2
                                //aqui tengo que validar si puedo comer 
                            }
                        }   
                        
                        //ataque doble de la reina
                        if(movimiento==2 && cuadroSeleccionado!=document.getElementById(cuadroObjetivo) && cuadroSeleccionado.getAttribute("reina")=="true")
                        {   
                            console.log("Validando segundo ataque de la reina")
                            console.log("Cuadro Inicial" + cuadroObjetivo)
                            console.log("Cuadro Seleccionado" + cuadroSeleccionado.getAttribute("x")+ "" + cuadroSeleccionado.getAttribute("y") )
                            let i=0;
                            let x=document.getElementById(cuadroObjetivo).getAttribute("x");
                            let y=document.getElementById(cuadroObjetivo).getAttribute("y");
                            let auxiliarAtaque=""
                            //esta variable me validara si puedo moverme a un sitio cuadro 
                            puedoAtacar=false;
                            //estas serian las posibilidades de ataque
                            while(i<posibilidadesDeAtaqueDeLaReina.length)
                            {
                                ...
                                document.getElementById("cuadro"+ posibilidadesDeAtaqueDeLaReina[i]).style.setProperty("Background-color","#FFF")
                                console.log("posibilidad donde la reina puede Atacar" +posibilidadesDeAtaqueDeLaReina[i] + "==" + x+""+y)
                            ...
                            if(diagonalesDeLaReina[2]!="99")document.getElementById("cuadro"+ diagonalesDeLaReina[2]).style.setProperty("Background-color","#FFF")
                            if(diagonalesDeLaReina[3]!="99")document.getElementById("cuadro"+ diagonalesDeLaReina[3]).style.setProperty("Background-color","#FFF")
                            //solo quiero validar la posibilidad de ataque 
                            if(puedoAtacar)
                            {
                                //elimina la ficha del cuadro seleccionado y lo introduce en el cuadro sobjetivo
                                document.getElementById(cuadroSeleccionado.getAttribute("id")).innerHTML="";
                                ...
                                //valida si puede hacer un ataque triple con la reina

                                console.log("VALIDACION tercer ATAQUE REINA")
                                //banderaS=1;
                                posibilidadesDeAtaqueDeLaReina=[];
                                posibilidadesDeLaReina=[];
                                diagonalesDeLaReina=["99","99","99","99"];
                                ...
                                while(x>posicionArriba && y>posicionIzquierda)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        ...
                                        if( ((x-1)!=9 && (y-1)!=-1 && (x-1)!=-1 &&( y-1)!=8) && document.getElementById("cuadro" + (x-1) + "" + (y-1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x-1) + "" + (y-1))
                                            movimiento=3;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[0]).style.setProperty("Background-color","#ff0")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                //ahora si,estaba confundido
                                                ...
                                                {
                                                    posibilidadesDeAtaqueDeLaReina.push((x-j) + "" + (y-j));
                                                    document.getElementById("cuadro" + (x-j) + "" + (y-j)).style.setProperty("Background-color","#ff0")
                                                    console.log((x-j) + "" + (y-j))
                                                }
                                                if(document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="1" || document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="2")break;
                                                ++j;
                                ...
                                while(x>posicionArriba && y<posicionDerecha)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x-1)!=9 &&  (y+1)!=-1 &&  (x-1)!=-1 && ( y+1)!=8) && document.getElementById("cuadro" + (x-1) + "" + (y+1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x-1) + "" + (y+1))
                                            movimiento=3;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[1]).style.setProperty("Background-color","#ff0")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x-j)<0 || (y+j)<0 || (x-j)>9||( y+j)>7))break;
                                ...
                                while(x<posicionAbajo && y>posicionIzquierda)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x+1)!=9 && (y-1)!=-1 && (x+1)!=-1 &&( y-1)!=8) && document.getElementById("cuadro" + (x+1) + "" + (y-1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x+1) + "" + (y-1))
                                            movimiento=3;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[2]).style.setProperty("Background-color","#ff0")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x+j)<0 || (y-j)<0 || (x+j)>9||( y-j)>7))break;
                                ...
                                while(x<posicionAbajo && y<posicionDerecha)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x-1)!=9 &&  (y+1)!=-1 &&  (x-1)!=-1 && ( y+1)!=8) && document.getElementById("cuadro" + (x+1) + "" + (y+1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x+1) + "" + (y+1))
                                            movimiento=3;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[3]).style.setProperty("Background-color","#ff0")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x+j)<0 || (y+j)<0 || (x+j)>9||( y+j)>7))break;
                        ...
                        //ataque triple de la reina
                        if(movimiento==3 && cuadroSeleccionado!=document.getElementById(cuadroObjetivo) && cuadroSeleccionado.getAttribute("reina")=="true")
                        {   
                            console.log("Validando segundo ataque de la reina")
                            console.log("Cuadro Inicial" + cuadroObjetivo)
                            console.log("Cuadro Seleccionado" + cuadroSeleccionado.getAttribute("x")+ "" + cuadroSeleccionado.getAttribute("y") )
                            ...
                            if(puedoAtacar)
                            {
                                ...
                                console.log("VALIDACION cuarto ATAQUE REINA")
                                //banderaS=1;
                                posibilidadesDeAtaqueDeLaReina=[];
                                posibilidadesDeLaReina=[];
                                diagonalesDeLaReina=["99","99","99","99"];
                                ...
                                while(x>posicionArriba && y>posicionIzquierda)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        ...
                                        if( ((x-1)!=9 && (y-1)!=-1 && (x-1)!=-1 &&( y-1)!=8) && document.getElementById("cuadro" + (x-1) + "" + (y-1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x-1) + "" + (y-1))
                                            movimiento=4;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[0]).style.setProperty("Background-color","#f0f")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                //ahora si,estaba confundido
                                                ...
                                                {
                                                    posibilidadesDeAtaqueDeLaReina.push((x-j) + "" + (y-j));
                                                    document.getElementById("cuadro" + (x-j) + "" + (y-j)).style.setProperty("Background-color","#f0f")
                                                    console.log((x-j) + "" + (y-j))
                                                }
                                                if(document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="1" || document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="2")break;
                                                ++j;
                                ...
                                while(x>posicionArriba && y<posicionDerecha)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x-1)!=9 &&  (y+1)!=-1 &&  (x-1)!=-1 && ( y+1)!=8) && document.getElementById("cuadro" + (x-1) + "" + (y+1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x-1) + "" + (y+1))
                                            movimiento=4;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[1]).style.setProperty("Background-color","#f0f")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x-j)<0 || (y+j)<0 || (x-j)>9||( y+j)>7))break;
                                ...
                                while(x<posicionAbajo && y>posicionIzquierda)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x+1)!=9 && (y-1)!=-1 && (x+1)!=-1 &&( y-1)!=8) && document.getElementById("cuadro" + (x+1) + "" + (y-1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x+1) + "" + (y-1))
                                            movimiento=4;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[2]).style.setProperty("Background-color","#f0f")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x+j)<0 || (y-j)<0 || (x+j)>9||( y-j)>7))break;
                                ...
                                while(x<posicionAbajo && y<posicionDerecha)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x-1)!=9 &&  (y+1)!=-1 &&  (x-1)!=-1 && ( y+1)!=8) && document.getElementById("cuadro" + (x+1) + "" + (y+1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x+1) + "" + (y+1))
                                            movimiento=4;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[3]).style.setProperty("Background-color","#f0f")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x+j)<0 || (y+j)<0 || (x+j)>9||( y+j)>7))break;
                        ...
                        //ataque cuarto de la reina
                        if(movimiento==4 && cuadroSeleccionado!=document.getElementById(cuadroObjetivo) && cuadroSeleccionado.getAttribute("reina")=="true")
                        {   
                            console.log("Validando segundo ataque de la reina")
                            console.log("Cuadro Inicial" + cuadroObjetivo)
                            console.log("Cuadro Seleccionado" + cuadroSeleccionado.getAttribute("x")+ "" + cuadroSeleccionado.getAttribute("y") )
                            ...
                            if(puedoAtacar)
                            {
                                ...
                                console.log("VALIDACION quinto ATAQUE REINA")
                                //banderaS=1;
                                posibilidadesDeAtaqueDeLaReina=[];
                                posibilidadesDeLaReina=[];
                                diagonalesDeLaReina=["99","99","99","99"];
                                ...
                                while(x>posicionArriba && y>posicionIzquierda)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        ...
                                        if( ((x-1)!=9 && (y-1)!=-1 && (x-1)!=-1 &&( y-1)!=8) && document.getElementById("cuadro" + (x-1) + "" + (y-1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x-1) + "" + (y-1))
                                            movimiento=5;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[0]).style.setProperty("Background-color","#000")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                //ahora si,estaba confundido
                                                ...
                                                {
                                                    posibilidadesDeAtaqueDeLaReina.push((x-j) + "" + (y-j));
                                                    document.getElementById("cuadro" + (x-j) + "" + (y-j)).style.setProperty("Background-color","#000")
                                                    console.log((x-j) + "" + (y-j))
                                                }
                                                if(document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="1" || document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="2")break;
                                                ++j;
                                ...
                                while(x>posicionArriba && y<posicionDerecha)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x-1)!=9 &&  (y+1)!=-1 &&  (x-1)!=-1 && ( y+1)!=8) && document.getElementById("cuadro" + (x-1) + "" + (y+1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x-1) + "" + (y+1))
                                            movimiento=5;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[1]).style.setProperty("Background-color","#000")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x-j)<0 || (y+j)<0 || (x-j)>9||( y+j)>7))break;
                                ...
                                while(x<posicionAbajo && y>posicionIzquierda)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x+1)!=9 && (y-1)!=-1 && (x+1)!=-1 &&( y-1)!=8) && document.getElementById("cuadro" + (x+1) + "" + (y-1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x+1) + "" + (y-1))
                                            movimiento=5;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[2]).style.setProperty("Background-color","#000")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x+j)<0 || (y-j)<0 || (x+j)>9||( y-j)>7))break;
                                ...
                                while(x<posicionAbajo && y<posicionDerecha)
                                {
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" )
                                    {
                                        if(((x-1)!=9 &&  (y+1)!=-1 &&  (x-1)!=-1 && ( y+1)!=8) && document.getElementById("cuadro" + (x+1) + "" + (y+1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            posibilidadesDeAtaqueDeLaReina.push((x+1) + "" + (y+1))
                                            movimiento=5;
                                            document.getElementById("cuadro" + diagonalesDeLaReina[3]).style.setProperty("Background-color","#000")
                                            //aqui comienza la posibilidades de movimiento dentro del ataque 
                                            while(1==1)
                                            {   
                                                if(((x+j)<0 || (y+j)<0 || (x+j)>9||( y+j)>7))break;
                        ...
                        //ataque cuarto de la reina
                        if(movimiento==5 && cuadroSeleccionado!=document.getElementById(cuadroObjetivo) && cuadroSeleccionado.getAttribute("reina")=="true")
                        {   
                            console.log("Validando segundo ataque de la reina")
                            console.log("Cuadro Inicial" + cuadroObjetivo)
                            console.log("Cuadro Seleccionado" + cuadroSeleccionado.getAttribute("x")+ "" + cuadroSeleccionado.getAttribute("y") )
                    ...
                    else
                    {
                        ...
                        if(document.getSelection().anchorNode.getAttribute("reina")=="false" && document.getSelection().anchorNode.getAttribute("x")==9 && document.getSelection().anchorNode.getAttribute("fichadelJugador")=="2")
                        {
                            //no debe presentar ese mensaje 
                            document.getElementById("cuadro"+document.getSelection().anchorNode.getAttribute("x") + document.getSelection().anchorNode.getAttribute("y") ).innerHTML="8";
                            //esto debe convertirla en reina
                                    ...
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="1" )
                                    {
                                        ...
                                        if( ((x-1)!=9 && (y-1)!=-1 && (x-1)!=-1 &&( y-1)!=8) && document.getElementById("cuadro" + (x-1) + "" + (y-1)).getAttribute("fichadelJugador")=="0")
                                        {
                                            ...
                                            {   
                                                ...
                                                if(document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="2" || document.getElementById("cuadro" + (x-j) + "" + (y-j)).getAttribute("fichadelJugador")=="1")break;
                                                ++j;
                                            } 
                                        }
                                        break;
                                    }
                                    if(document.getElementById("cuadro" + x + "" + y).getAttribute("fichadelJugador")=="2" && x!=document.getElementById(cuadroObjetivo).getAttribute("x") && y!=document.getElementById(cuadroObjetivo).getAttribute("y"))break;
                                    //si el bucle no termina, este agrega una posibilidad de movimiento 
                                    --x;
                                    --y;
                                    if(x==9 || y==-1 || x==-1 || y==8)break;
                        ...
                        console.log("movimiento:" + movimiento + " cuadroSeleccionado:" + cuadroSeleccionado+ "== cuadroObjetivo:" + document.getElementById(cuadroObjetivo))
                        //ataque doble de la reina
                        if(movimiento==2 && cuadroSeleccionado!=document.getElementById(cuadroObjetivo) && cuadroSeleccionado.getAttribute("reina")=="true")
                        {   
                            console.log("Validando segundo ataque de la reina")
                            ...
                            if(puedoAtacar)
                            {
                                ...
                                //validar si puede atacar doble
                                //==================================
                                console.log("VALIDACION Tercer ATAQUE REINA J2")
                                //banderaS=1;
                                posibilidadesDeAtaqueDeLaReina=[];
                                posibilidadesDeLaReina=[];
                                diagonalesDeLaReina=["99","99","99","99"];
                        ...
                        {   
                            ...
                            if(puedoAtacar)
                            {
                                ...
                                //validar si puede atacar doble
                                //==================================
                                console.log("VALIDACION cUARTO ATAQUE REINA J2")
                                //banderaS=1;
                                posibilidadesDeAtaqueDeLaReina=[];
                                posibilidadesDeLaReina=[];
                                diagonalesDeLaReina=["99","99","99","99"];
                        ...
                        {   
                            ...
                            if(puedoAtacar)
                            {
                                ...
                                //validar si puede atacar doble
                                //==================================
                                console.log("VALIDACION QUINTA ATAQUE REINA J2")
                                //banderaS=1;
                                posibilidadesDeAtaqueDeLaReina=[];
                                posibilidadesDeLaReina=[];
                                diagonalesDeLaReina=["99","99","99","99"];
